            ...
            <label>
                {data.image ? (
                    <img
                        ...
                        alt="user-image"
                        className='w-16 h-16 rounded-full object-cover mt-5 ring ring-emerald-200 hover:opacity-80'
                    />
                ) : (
                    <div className ='inline-flex items-center gap-2 mt-5 text-emerald-700 hover:text-emerald-800 cursor-pointer'>
